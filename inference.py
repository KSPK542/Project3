...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        if noisyDistance == None:
            return 0.0
        Exact_Dist = manhattanDistance(pacmanPosition, ghostPosition)
        return busters.getObservationProbability(noisyDistance, Exact_Dist)
        raiseNotDefined()
...
class ExactInference(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for Old_position in self.allPositions:
            ...
            Old_problem = self.beliefs[Old_position]
            for New_Position in New_Pos_Dist.keys():
                dist[New_Position] += Old_problem * New_Pos_Dist[New_Position]
        self.beliefs = dist
...
class ParticleFilter(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for i in range(self.numParticles):
            ...
            if particle in x:
                self.particles[i] = x[particle].sample()
            else:
